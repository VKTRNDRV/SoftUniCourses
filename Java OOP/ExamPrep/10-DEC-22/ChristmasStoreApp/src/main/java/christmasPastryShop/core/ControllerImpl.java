...
public class ControllerImpl implements Controller {
    ...
    public String reserveBooth(int numberOfPeople) {
        Booth booth = findBoothFor(numberOfPeople);
        if(booth == null){
        ...
        return String.format(OutputMessages
                .BOOTH_RESERVED, booth.getBoothNumber(), numberOfPeople);
    }

    private Booth findBoothFor(int numberOfPeople){
