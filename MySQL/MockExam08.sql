...
select left(`description`, 15) as `content`,
...
# 03
/*Reduce all products quantity by 5 
for products with quantity equal to or greater than 60
...
# 05
/*Extract info about the name of categories.
...
# 06
/*Filter products which price is higher than 1000
	and their quantity is lower than 30.
...
# 07
/*Write a query that returns for all reviews 
	which content starts with ‘My’ 
	and the characters of the content are more than 61 symbols.
...
and reduces the prices by 30% of all products
	which have reviews with rating less than 4
